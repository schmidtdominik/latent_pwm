...
#       https://github.com/facebookresearch/moolib/blob/main/examples/common/vtrace.py
# which itself is an adaption of
...
VTraceReturns = collections.namedtuple("VTraceReturns", "vs pg_advs")


def action_log_probs(policy_log_probs, actions):
    return -F.nll_loss(policy_log_probs.flatten(0, 1),
                       actions.flatten(), reduction="none").view_as(actions)
...
def from_logits(
    ...
    Returns:
      A `VTraceFromLogitsReturns` namedtuple with the following fields:
        ...
        pg_advs: A float 32 tensor of shape [T, B]. Can be used as an
    ...
    """
    log_rhos = target_policy_log_probs - behavior_policy_log_probs
    ...
    return VTraceFromLogitsReturns(
        log_rhos=log_rhos,
        behavior_action_log_probs=behavior_policy_log_probs,
        target_action_log_probs=target_policy_log_probs,
...
def from_importance_weights(
    ...
    Returns:
      A VTraceReturns namedtuple (vs, pg_advs) where:
        vs: A float32 tensor of shape [T, B]. Can be used as target to
          train a baseline (V(x_t) - vs_t)^2.
        pg_advs: A float32 tensor of shape [T, B]. Can be used as the
    ...
    pg_advs = clipped_pg_rhos * (rewards + discounts * vs_t_plus_1 - values)

    # Make sure no gradients backpropagated through the returned values.
    return VTraceReturns(vs=vs, pg_advs=pg_advs)
